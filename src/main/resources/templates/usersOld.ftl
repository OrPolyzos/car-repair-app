...
<body align="center">
    ...
    <hr></hr>
        ...
        <form action="/admin/users/search" method="GET" id="userSearchForm" name="userSearchForm">
            ...
            AFM: <input class="searchInput" type="text" name="afm" id="afm" placeholder="123456789" value="${userSearchForm.afm!""}"/>
            <#list spring.status.errorMessages as error>
                 <span>${error}</span>
            </#list>

            <@spring.bind "userSearchForm.email"/>
            Email: <input class="searchInput" type="text" name="email" id="email" placeholder="john@doe.com" value="${userSearchForm.email!""}"/>
            <#list spring.status.errorMessages as error>
                 <span>${error}</span>
            </#list>
            <br><br>
