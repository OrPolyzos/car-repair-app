                ...
                <fieldset class="Norm">
                    ...
                    <div class="col-md-4">
                        ...
                        <@spring.bind "partSearchForm.partPriceStart"/>
                            <input type="number" class="form-control" name="partPriceStart" id="partPriceStart" placeholder="0" value="${partSearchForm.partPriceStart!""}"/>
                        <#list spring.status.errorMessages as error>
                            <span class="errorRed">${error}</span>
                        </#list>
                    </div>
                    <div class="col-md-4">
                        ...
                        <@spring.bind "partSearchForm.partPriceEnd"/>
                            <input type="number" class="form-control" name="partPriceEnd" id="partPriceEnd" placeholder="100" value="${partSearchForm.partPriceEnd!""}"/>
                        <#list spring.status.errorMessages as error>
                            <span class="errorRed">${error}</span>
                        </#list>
                    </div>
