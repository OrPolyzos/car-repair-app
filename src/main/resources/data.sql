...
LOAD DATA LOCAL INFILE 'C:\\Users\\Jim\\Desktop\\Projects\\carrepair\\Users.csv'
INTO TABLE users
...
LOAD DATA LOCAL INFILE 'C:\\Users\\Jim\\Desktop\\Projects\\carrepair\\Vehicles.csv'
INTO TABLE vehicles
FIELDS TERMINATED BY ';'
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE 'C:\\Users\\Jim\\Desktop\\Projects\\carrepair\\Parts.csv'
INTO TABLE parts
FIELDS TERMINATED BY ';'
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE 'C:\\Users\\Jim\\Desktop\\Projects\\carrepair\\Repairs.csv'
INTO TABLE repairs
FIELDS TERMINATED BY ';'
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
