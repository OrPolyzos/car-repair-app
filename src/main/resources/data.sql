...
LOAD DATA LOCAL INFILE 'C:\\Users\\vicky\\Desktop\\carrepair\\Users.csv'
INTO TABLE users
...
LOAD DATA LOCAL INFILE 'C:\\Users\\vicky\\Desktop\\carrepair\\Vehicles.csv'
INTO TABLE vehicles
FIELDS TERMINATED BY ';'
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE 'C:\\Users\\vicky\\Desktop\\carrepair\\Repairs2.csv'
INTO TABLE repairs
FIELDS TERMINATED BY ';'
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
